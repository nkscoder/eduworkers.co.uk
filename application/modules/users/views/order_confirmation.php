...
<head>
    ...
    <title>Eduworkers Order Confirmation </title>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="wrapper" bgcolor="#FFFFFF">
    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                        <td class="alert alert-warning" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 16px; vertical-align: top; color: #fff; font-weight: 500; text-align: center; border-radius: 3px 3px 0 0; background-color: #2d3e50; margin: 0; padding: 20px;" align="center" bgcolor="#FF9F00" valign="left">
                            <img src="http://www.eduw.clarksfield.com/assets//img/final_logo.png" alt="" align="left" width="80">
                          <img src="http://www.eduw.clarksfield.com/assets//img/final-logo-edit.png" alt=""align="center" width="200" style="padding-top: 20px;">
                         <!-- <h1 style="">Eduworkers</h1> -->
                        </td>
                    </tr>
    <tr>
            ...
            <table width="90%" cellpadding="0" cellspacing="0" border="0" class="container" style="margin-left:5%; margin-right:5%;">
                <tr>
                    <td width="20%" class="mobile" style="font-family:arial; font-size:12px; line-height:18px; text-align:center">
                        <h1 style="color: tomato">Order placement confirmation</h1>
                    </td>
    ...
    <tr>
        ...
        <td align="left">
            ...
            <table width="90%" cellpadding="0" cellspacing="0" border="0" class="container" style="margin-left:5%; margin-right:5%;">
                <tr>
                    <td width="40%" class="mobile" style="font-family:arial; font-size:12px; line-height:18px; ">
                        <h3>Hi,</h3>
                    </td>
        ...
        <td align="left">
            ...
            <table width="90%" cellpadding="0" cellspacing="0" border="0" class="container" style="margin-left:5%; margin-right:5%;">
                <tr>
                    <td width="40%" class="mobile" style="font-family:arial; font-size:12px; line-height:18px; ">
                        <p>Thanks you for trusting Eduworkers and giving us the opportunity to serve you.</p>
                    </td>
      ...
      <tr>
        <td align="left">
            ...
            <table width="90%" cellpadding="0" cellspacing="0" border="0" class="container" style="margin-left:5%; margin-right:5%;">
                <tr>
                    <td width="40%" class="mobile" style="font-family:arial; font-size:12px; line-height:18px; ">
                        <p>This is a confirmation email for you that we have accepted your order and have started working on it and will be able to deliver you work in line with the specifications provided and by the agreed date of delivery.</p>
                    </td>
    ...
    <tr>
        <td align="left">
            ...
            <table width="90%" cellpadding="0" cellspacing="0" border="0" class="container" style="margin-left:5%; margin-right:5%;">
                <tr>
                    <td width="40%" class="mobile" style="font-family:arial; font-size:12px; line-height:18px; ">
                        <p>Please ensure you provide all the data (that is important in terms of completing a task), this may include:</p>
                    </td>
                ...
                <tr>
                    <td width="40%" class="mobile" style="font-family:arial; font-size:12px; line-height:18px; ">
                        <ol>
                            ...
                            <li>Any specific information, sources or data that you want us to incorporate or take care of.</li>
                            <li>Lecture notes so that we know what are your tutor’s expectations.</li>
                            <li>Version of any software or tool that you want us to use.</li>
                        </ol>
                    </td>
    ...
    <tr>
        <td align="left">
            ...
            <table width="90%" cellpadding="0" cellspacing="0" border="0" class="container" style="margin-left:5%; margin-right:5%;">
                <tr>
                    <td width="40%" class="mobile" style="font-family:arial; font-size:12px; line-height:18px; ">
                        <p>We would like to request you to share your Dropbox ID with us ASAP, as there are times when it is difficult to share completed work via email and in that case, we would sharing it with you on Dropbox. If you do not have an Dropbox ID, you just need to go to <a href="">www.dropbox.com</a> and signup with your existing email id and share your email id with us. </p>
                    </td>
 ...
 <tr>
        <td align="left">
            ...
            <table width="90%" cellpadding="0" cellspacing="0" border="0" class="container" style="margin-left:5%; margin-right:5%;">
                <tr>
                    <td width="40%" class="mobile" style="font-family:arial; font-size:12px; line-height:18px;">
                       <p>Please refer to Terms and Conditions (hyperlinked)</p>
                    </td>
